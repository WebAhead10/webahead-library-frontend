...
export default function StyledDropzone({ fileTypes, height, width, prepareUpload, text, value, loading, error }) {
  ...
  return (
    <div className="dropzone-container" style={{ marginBottom: isMobile && '20px' }}>

...
const About = () => {
  ...
  return (<div className="about-container-rtl">
    <header>
      ...
      <section>
        <p>
          "نبش" هي مبادرة مجتمعية تسعى إلى النبش في تاريخ فلسطين المكتوب ما قبل تطور الحوسبة الرقمية، مع التركيز على فترة نهاية فترة الحكم العثماني وكل فترة الانتداب البريطاني، بهدف جعله أكثر إتاحة واستخدامًا لأغراض البحث والتعليم والإبداع والإنتاج المعرفي. تأسست المبادرة عام 2022 على يد مجموعة من الناشطين والناشطات الفلسطينيين المستقلين، وتهدف إلى رقمنة وتحويل المواد الأرشيفية، مثل الصحف القديمة والنشرات الإحصائية، إلى موارد رقمية يمكن البحث فيها والاستفادة منها بسهولة ومن ثم استعمال هذه المواد من أجل بناء مشاريع مختلفة.
        </p>
      </section>
      <section>
        <h2>مهمتنا</h2>
        <p>
          تتمثل مهمتنا في سد الفجوة بين الكم الهائل من المعلومات التاريخية المحفوظة في الأرشيف، والتحديات التي تعيق الوصول إليها واستخدامها. من خلال التعاون مع الأفراد والمؤسسات والجهات التعليمية، نطمح إلى تمكين المساهمة التطوعية من الجميع، وتعزيز البحث التاريخي، وتعميق الفهم لتاريخ فلسطين.
        </p>
      </section>
      <section>
        <h2>لماذا "نبش"؟</h2>
        <p>
          توفر الوثائق الأرشيفية، مثل الصحف القديمة والسجلات الحكومية، مصدر معلومات قيّم عن التحولات الاجتماعية والحياة اليومية في فلسطين. ومع ذلك، يواجه الباحثون والباحثات تحديات كبيرة عند التعامل مع هذه المواد، من أبرزها:
        </p>
        <ul>
        ...
        <p>
          تواجه "نبش" هذه التحديات من خلال حلول مبتكرة قائمة على التعاون المجتمعي والتعليم. على سبيل المثال، نسّقنا مع طلاب وطالبات المدارس الثانوية للمشاركة في فهرسة الصحف العربية، مما يساهم في إتاحة هذا المحتوى القيّم للأجيال القادمة.
        </p>
      </section>
      <section>
        <h2>منهجنا</h2>
        <p>
          للتغلب على العوائق وبناء قواعد بيانات قابلة للبحث، تعتمد "نبش" على الدمج بين المشاركة المجتمعية والتعليم. من خلال إشراك الطلاب والطالبات والمتطوعين والمتطوعات، نقدم لهم خبرة عملية في التعامل مع المصادر التاريخية الأولية، مما يثري تجربتهم التعليمية ويساهم في تحقيق أهداف المشروع.
        </p>
      </section>
      <section>
      ...
      <section>
        ...
        <p>
          إذا كنت باحثًا، باحثة، معلمًا، معلمة، طالبًا، طالبة، أو مهتمًا/مهتمة بتاريخ فلسطين، ندعوك للانضمام إلينا في "نبش" للمساهمة في حفظ هذا التاريخ الثري. معًا، يمكننا تحويل هذه الموارد إلى أدوات تعليمية وبحثية ومصدر إلهام للإبداع والإنتاج متاحة للجميع، مع تعزيز روح التعاون والتعلم والمشاركة الفعّالة.
        </p>
      </section>
    </div>
)} else {

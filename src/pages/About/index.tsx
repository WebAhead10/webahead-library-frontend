...
const About = () => {
  ...
  return (<div className="about-container-rtl">
    <header>
      ...
      <section>
        <p>
          "نبش" هي مبادرة مجتمعية تسعى إلى النبش في تاريخ فلسطين المكتوب ما قبل تطور الحوسبة الرقمية، مع التركيز على نهاية فترة الحكم العثماني وكل فترة الانتداب البريطاني، بهدف جعله أكثر إتاحة واستخدامًا لأغراض البحث والتعليم والإبداع والإنتاج المعرفي. تأسست المبادرة عام 2022 على يد مجموعة من الناشطين والناشطات الفلسطينيين المستقلين، وتهدف إلى رقمنة وتحويل المواد الأرشيفية، مثل الصحف القديمة والنشرات الإحصائية، إلى موارد رقمية يمكن البحث فيها والاستفادة منها بسهولة ومن ثم استعمال هذه المواد من أجل بناء مشاريع مختلفة.
        </p>
      </section>
      <section>
        <h2>مهمتنا</h2>
